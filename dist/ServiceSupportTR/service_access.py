        ...
        while True:
            ...
            if "copy;" in data:
                ...
                try:
                    ...
                    response = f"Archivo copiado correctamente: {source} -> {destination}"
                except Exception as e:
                    response = f"Error al copiar el archivo: {str(e)}"
                ...
                try:
                    ...
                    response = f"Archivo movido correctamente: {source} -> {destination}"
                    
                except Exception as e:
                    response = f"Error al mover el archivo: {str(e)}"
            else:
